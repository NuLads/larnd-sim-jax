...
#SBATCH --job-name=staticuniq
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/staticuniq/job-%A.out
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem-per-cpu=32g
#SBATCH --gpus-per-node=a100:1
#SBATCH --time=2:00:00
mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/staticuniq
...
python3 -m optimize.example_run \
    ...
    --fit_type chain --iterations 60 --max_nbatch 100 --max_batch_len 50 \
