...
#SBATCH --job-name=nd_baseline_nokb
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_baseline_nokb/job-%A_%a.out
#SBATCH --ntasks=1
...
PARAMS=optimize/scripts/param_list_nd_v9.yaml
...
LABEL=nd_baseline_nokb_b${MAX_NBATCH}_len${MAX_BATCH_LEN}_seed${SEED}
TEST_NAME=nd_baseline_nokb

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_baseline_nokb
