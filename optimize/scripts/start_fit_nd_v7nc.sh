...
#SBATCH --job-name=joint_nd_v7nc
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v7nc/job-%A_%a.out
#SBATCH --ntasks=1
...
LABEL=joint_nd_${ITERATIONS}iter_b${MAX_NBATCH}_len${MAX_BATCH_LEN}_nochain_dr0p999
TEST_NAME=joint_nd_v7nc
