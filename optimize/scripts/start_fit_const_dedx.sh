...
#SBATCH --job-name=diffsim_const_dedx_multi
...
LABEL=true_throughmuons_multipar_const_dedx_mean_noise_tgtsim_n_neigh${N_NEIGH}_mode_${MODE}_e_sampling_${SAMPLING_STEP}cm_seed_stgy_${SEED_STRATEGY}_grad_clip${MAX_CLIP_NORM_VAL}_${LR_SCHEDULER}_bt${BATCH_SIZE}_tgtsd${TARGET_SEED}_dtsd${DATA_SEED}_adam_${LOSS}

ONAME=fit_noise_const_dedx_multi_${SLURM_ARRAY_JOB_ID}
nvidia-smi
