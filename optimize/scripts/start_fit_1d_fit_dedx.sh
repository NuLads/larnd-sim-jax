...
#SBATCH --job-name=diffsim_fit_dedx
...
LABEL=true_throughmuons_1dfit_fit_dedx_priw${DEDX_PRIOR_WEIGHT}_dlr${DEDX_LR}_dsi${DEDX_START_ITER}_noise_tgtsim_n_neigh${N_NEIGH}_mode_${MODE}_e_sampling_${SAMPLING_STEP}cm_seed_stgy_${SEED_STRATEGY}_grad_clip${MAX_CLIP_NORM_VAL}_${LR_SCHEDULER}_bt${BATCH_SIZE}_tgtsd${TARGET_SEED}_dtsd${DATA_SEED}_adam_${LOSS}

ONAME=fit_noise_fit_dedx_${SLURM_ARRAY_JOB_ID}
nvidia-smi
