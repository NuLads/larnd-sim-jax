...
#SBATCH --job-name=chain_snap
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/chain_snap/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=chain_snap

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/chain_snap
