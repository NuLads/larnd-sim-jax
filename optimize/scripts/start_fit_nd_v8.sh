...
#SBATCH --job-name=joint_nd_v8
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v8/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_v8

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v8
