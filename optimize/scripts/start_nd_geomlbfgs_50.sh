...
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_50/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=nd_geomlbfgs_50

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_50
