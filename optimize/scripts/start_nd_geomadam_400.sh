...
#SBATCH --job-name=nd_geomadam_400
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomadam_400/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=nd_geomadam_400

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomadam_400
