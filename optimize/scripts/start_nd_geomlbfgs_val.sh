...
#SBATCH --job-name=nd_geomlbfgs_val
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_val/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=nd_geomlbfgs_val

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_val
