...
#SBATCH --job-name=joint_nd_v13
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v13/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_v13

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v13
