...
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/cprofile/job-%A.out
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem-per-cpu=32g
#SBATCH --gpus-per-node=a100:1
#SBATCH --time=2:00:00
mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/cprofile
...
export JAX_COMPILATION_CACHE_DIR=/lscratch/pgranger/freshcache_${SLURM_JOB_ID}
