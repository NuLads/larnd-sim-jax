...
#SBATCH --job-name=bench_vec
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/bench_vec/job-%A_%a.out
#SBATCH --ntasks=1
...
mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/bench_vec
