...
#SBATCH --job-name=joint_nd_staged
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_staged/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_staged

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_staged
