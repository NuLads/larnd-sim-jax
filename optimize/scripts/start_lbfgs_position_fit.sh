...
#SBATCH --job-name=lbfgsfit
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/lbfgsfit/job-%A.out
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem-per-cpu=32g
#SBATCH --gpus-per-node=a100:1
#SBATCH --time=4:00:00
mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/lbfgsfit
...
python3 -m optimize.example_run \
    ...
    --fit_type chain --iterations 80 --max_nbatch 100 --max_batch_len 50 \
    ...
    --lbfgs_position_fit \
    --out_label lbfgsfit --test_name lbfgsfit 2>&1 | grep -iE 'LBFGS-FIT|Error|Traceback|Padding' | tail -60
"
echo "=== done ==="
