...
#SBATCH --job-name=joint_1d_v6
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_1d_v6/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_1d_v6

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_1d_v6
