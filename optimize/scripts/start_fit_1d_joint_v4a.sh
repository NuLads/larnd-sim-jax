...
#SBATCH --job-name=joint_1d_v4a
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_1d_v4a/job-%A_%a.out
#SBATCH --ntasks=1
...
LABEL=joint_1d_${PARAM}_${ITERATIONS}iter_b${MAX_NBATCH}_len${MAX_BATCH_LEN}_dr0p999
TEST_NAME=joint_1d_v4a
