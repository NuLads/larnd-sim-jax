...
#SBATCH --job-name=joint_nd_v10
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v10/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_v10

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v10
