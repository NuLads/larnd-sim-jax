...
#SBATCH --job-name=nd_geomlbfgs_50
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_50da/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=nd_geomlbfgs_50da

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/nd_geomlbfgs_50da
