...
#SBATCH --job-name=truepos_test
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/truepos_test/job-%A_%a.out
#SBATCH --ntasks=1
...
LABEL=truepos_${PARAM}_${ITERATIONS}iter_b${MAX_NBATCH}_len${MAX_BATCH_LEN}_nochain_dr0p999
TEST_NAME=truepos_test
