...
#SBATCH --job-name=joint_nd_fastdecay
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_fastdecay/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_fastdecay

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_fastdecay
...
python3 -m optimize.example_run \
    ...
    --lr_kw '{\"decay_rate\" : 0.995, \"init_value\" : 0, \"warmup_steps\": 500}' \
