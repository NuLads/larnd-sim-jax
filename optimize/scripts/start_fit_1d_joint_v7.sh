...
#SBATCH --job-name=joint_1d_v7
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_1d_v7/job-%A_%a.out
#SBATCH --ntasks=1
...
PARAMS=("Ab" "kb" "lifetime" "eField" "tran_diff" "long_diff" "shift_z" "shift_x" "shift_y")
...
LABEL=joint_1d_${PARAM}_${ITERATIONS}iter_b${MAX_NBATCH}_len${MAX_BATCH_LEN}_chainfreq${CHAIN_UPDATE_FREQ}_dr0p999
TEST_NAME=joint_1d_v7

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_1d_v7
