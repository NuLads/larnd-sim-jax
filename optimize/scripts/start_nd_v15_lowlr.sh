...
#SBATCH --job-name=joint_nd_v15
#SBATCH --output=/sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v15/job-%A_%a.out
#SBATCH --ntasks=1
...
TEST_NAME=joint_nd_v15

mkdir -p /sdf/group/neutrino/pgranger/larnd-sim-jax/logs/joint_nd_v15
