...
if __name__ == '__main__':
    ...
    parser.add_argument('--flow_quadrature_nodes', type=int, default=None,
                        choices=[8, 12, 16, 24, 32],
                        help='Optional global number of Gauss-Legendre nodes for flow quadrature mode.')
    parser.add_argument('--flow_quadrature_y_clip', type=float, default=None,
                        help='Optional global half-range in normalized flow latent y integrated by quadrature ([-clip, clip]).')
