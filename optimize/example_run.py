...
if __name__ == '__main__':
    ...
    parser.add_argument('--keep_in_memory', default=True, action=argparse.BooleanOptionalAction, help='Keep the expected output of each batch in memory (default on; --no-keep_in_memory re-reads the target file from disk every iteration)')
