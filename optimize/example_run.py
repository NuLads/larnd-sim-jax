...
if __name__ == '__main__':
    ...
    parser.add_argument('--keep_in_memory', default=False, action=argparse.BooleanOptionalAction, help='Keep the expected output of each batch in memory (avoids re-reading the target file from disk every iteration; costs host memory proportional to the number of batches)')
